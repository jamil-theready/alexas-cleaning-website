        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-6 md:gap-4">
              ...
              <a
                href="https://nextdoor.com/pages/alexas-cleaning-services/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Nextdoor"
                className="text-white/60 transition-colors hover:text-yellow"
              >
                <svg className="h-6 w-6 md:h-5 md:w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.62 17.354h-2.665a.36.36 0 01-.36-.36v-5.209c0-1.322-.812-2.278-2.163-2.278-1.35 0-2.162.956-2.162 2.278v5.209a.36.36 0 01-.36.36H7.245a.36.36 0 01-.36-.36v-5.03c-1.014-.243-2.043-1.078-2.148-2.804l-.055-.9a.36.36 0 01.36-.382h2.235c.199 0 .36.161.36.36v.541c0 .434.352.786.786.786h.24c.532-1.647 2.087-2.719 3.769-2.719 2.535 0 4.548 1.784 4.548 4.492v5.656a.36.36 0 01-.36.36z" />
                </svg>
              </a>
            </div>
          </div>
