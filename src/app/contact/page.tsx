              ...
              <div className="rounded-2xl bg-light-bg p-8">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a href="https://www.yelp.com/biz/alexa-s-house-cleaning-placerville" target="_blank" rel="noopener noreferrer" aria-label="Yelp" className="text-dark-gray/50 transition-colors hover:text-burgundy">
