...
export const metadata: Metadata = {
  title: "Cleaning Services in Diamond Springs CA | Alexa's Cleaning",
  description:
...
const services = [
  { name: "House Cleaning", href: "/services/house-cleaning", desc: "Weekly, bi-weekly, or monthly cleaning tailored to your Diamond Springs home." },
  { name: "Deep Cleaning", href: "/services/deep-cleaning", desc: "Top-to-bottom deep clean for seasonal refreshes or move-in prep in Diamond Springs." },
  { name: "Commercial Cleaning", href: "/services/commercial-cleaning", desc: "Offices, retail, and commercial spaces along Pleasant Valley Road and Diamond Road." },
  { name: "Post-Construction Cleanup", href: "/services/post-construction-cleaning", desc: "Dust, debris, and residue removal after your Diamond Springs renovation." },
  { name: "Airbnb & Vacation Rental", href: "/services/airbnb-cleaning", desc: "Fast turnovers for Gold Country vacation rentals and Airbnbs in Diamond Springs." },
  { name: "Apartment Cleaning", href: "/services/apartment-cleaning", desc: "Move-in/move-out cleans for Diamond Springs apartments and rentals." },
];

const faqs = [
  {
    q: "How much does house cleaning cost in Diamond Springs?",
    a: "House cleaning in Diamond Springs typically ranges from $120 to $250 depending on the size of your home and the type of clean. We provide free quotes with no obligation so you know exactly what to expect before we start.",
  },
  {
    q: "Do you clean homes throughout Diamond Springs?",
    a: "Yes. We clean homes and businesses throughout Diamond Springs including neighborhoods along Pleasant Valley Road, Diamond Road, Missouri Flat Road, and all surrounding areas. We are based nearby in Placerville so Diamond Springs is one of our closest service areas.",
  },
  {
  ...
  {
    q: "Can I get a one-time deep clean in Diamond Springs?",
    a: "Absolutely. We offer one-time deep cleans, move-in/move-out cleans, and post-construction cleanups in addition to our recurring service. No contract is required for any service type.",
  },
  {
    q: "How do I book a cleaning in Diamond Springs?",
...
export default function DiamondSpringsPage() {
  return (
    <>
      <Header />
      <main>
        <PageHero
          title="Cleaning Services in Diamond Springs, CA"
          subtitle="Trusted by Diamond Springs families for over 15 years. Licensed, insured, and committed to making your home or business spotless."
        />
          ...
          <div className="mx-auto max-w-[800px] px-6">
            <div className="rounded-2xl border border-yellow/60 bg-white p-6">
              ...
              <p className="text-[16px] leading-relaxed text-dark-gray">
                ...
                cleaning in Diamond Springs, CA with over 15 years of
                experience. We offer house cleaning, deep cleaning, commercial
                cleaning, and specialty services throughout Diamond Springs
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
                  Diamond Springs&apos; Trusted Cleaning Company
                </h2>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Diamond Springs is a historic Gold Rush town just south of
                  Placerville, and we have been cleaning homes here for over
                  15 years. From the properties along Pleasant Valley Road
                  to the neighborhoods off Diamond Road and Missouri Flat,
                  we know this community well. Our founder Alejandra Ortiz
                  built this business one home at a time in El Dorado
                  County, and that local commitment shows in every clean.
                </p>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Whether you live off Pleasant Valley Road, near the
                  Diamond Springs town center, or anywhere in between, we
              ...
              <div className="overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Alexa's Cleaning Services team serving Diamond Springs CA homes"
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-4 text-center font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
              Services Available in Diamond Springs
            </h2>
            <p className="mx-auto mb-12 max-w-[600px] text-center text-[17px] text-dark-gray">
              ...
              services throughout Diamond Springs and the surrounding area.
            </p>
        ...
        {/* Why Diamond Springs Chooses Us */}
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-12 text-center font-[family-name:var(--font-serif)] text-[28px] text-white md:text-[36px]">
              Why Diamond Springs Families Choose Us
            </h2>
              ...
              {[
                {
                  ...
                  detail: "Based in Placerville, minutes from Diamond Springs.",
                },
                {
                  stat: "5.0",
                  label: "Google Rating",
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-[800px] px-6">
            ...
            <p className="mx-auto mb-12 max-w-[550px] text-center text-[17px] text-dark-gray">
              Common questions from Diamond Springs homeowners about our cleaning services.
            </p>
        ...
        <section className="bg-light-bg py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <p className="mx-auto mb-10 max-w-[600px] text-[17px] text-dark-gray">
              In addition to Diamond Springs, we provide cleaning services
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[32px] text-white md:text-[48px]">
              Ready for a Cleaner Home in Diamond Springs?
            </h2>
            ...
            __html: JSON.stringify([
              {
                ...
                name: "Alexa's Cleaning Services - Diamond Springs",
                url: "https://www.alexascleaningplacerville.com/areas/diamond-springs",
                telephone: "+15302146361",
                email: "alexascleaningplacerville@gmail.com",
                description:
                  "Professional house cleaning and commercial cleaning services in Diamond Springs CA. Licensed, insured, and trusted by local families for over 15 years.",
                areaServed: {
                  "@type": "City",
