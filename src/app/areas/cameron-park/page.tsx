...
const services = [
  { name: "House Cleaning", href: "/services/house-cleaning", desc: "Weekly, bi-weekly, or monthly cleaning tailored to your Cameron Park home." },
  { name: "Deep Cleaning", href: "/services/deep-cleaning", desc: "Top-to-bottom deep clean for seasonal refreshes or move-in prep in Cameron Park." },
  { name: "Commercial Cleaning", href: "/services/commercial-cleaning", desc: "Offices, retail, and commercial spaces along Cameron Park Drive and beyond." },
  { name: "Post-Construction Cleanup", href: "/services/post-construction-cleaning", desc: "Dust, debris, and residue removal after your Cameron Park renovation." },
  { name: "Airbnb & Vacation Rental", href: "/services/airbnb-cleaning", desc: "Fast turnovers for Cameron Park vacation rentals and Airbnbs near Highway 50." },
  { name: "Apartment Cleaning", href: "/services/apartment-cleaning", desc: "Move-in/move-out cleans for Cameron Park apartments and rentals." },
];

const faqs = [
  {
    q: "How much does house cleaning cost in Cameron Park?",
    a: "House cleaning in Cameron Park typically ranges from $120 to $250 depending on the size of your home and the type of clean. We provide free quotes with no obligation so you know exactly what to expect before we start.",
  },
  {
    q: "Do you clean homes near Cameron Park Lake?",
    a: "Yes. We clean homes and businesses throughout Cameron Park including the Cameron Park Lake area, Cameron Park Drive, Country Club Drive, Coach Lane, and all surrounding neighborhoods. We are just a short drive from Cameron Park via Highway 50.",
  },
  {
  ...
  {
    q: "What day of the week can I schedule cleaning in Cameron Park?",
    a: "We offer flexible scheduling Monday through Saturday. You pick the day and frequency that works best for your household. Weekly, bi-weekly, monthly, or one-time cleans are all available with no contracts.",
  },
  {
    q: "How do I book a cleaning in Cameron Park?",
...
export default function CameronParkPage() {
  return (
    <>
      <Header />
      <main>
        <PageHero
          title="Cleaning Services in Cameron Park, CA"
          subtitle="Trusted by Cameron Park families for over 15 years. Licensed, insured, and committed to making your home or business spotless."
        />
          ...
          <div className="mx-auto max-w-[800px] px-6">
            <div className="rounded-2xl border border-yellow/60 bg-white p-6">
              ...
              <p className="text-[16px] leading-relaxed text-dark-gray">
                ...
                cleaning in Cameron Park, CA with over 15 years of experience.
                We offer house cleaning, deep cleaning, commercial cleaning,
                and specialty services throughout Cameron Park and El Dorado
                County. No contracts required. Call (530) 214-6361 for a free
                quote.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
                  Cameron Park&apos;s Trusted Cleaning Team
                </h2>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Cameron Park sits right along the Highway 50 corridor,
                  and we have been cleaning homes here for over 15 years.
                  From the neighborhoods around Cameron Park Lake to the
                  homes off Country Club Drive and Cameron Park Drive, we
                  know this community inside and out. Our founder Alejandra
                  Ortiz built this business one home at a time in El Dorado
                  County, and that dedication shows in every clean.
                </p>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Whether you live near the lake, off Coach Lane, or
                  anywhere along the Cameron Park corridor, we provide
              ...
              <div className="overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Alexa's Cleaning Services team serving Cameron Park CA homes"
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-4 text-center font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
              Services Available in Cameron Park
            </h2>
            <p className="mx-auto mb-12 max-w-[600px] text-center text-[17px] text-dark-gray">
              ...
              services throughout Cameron Park and the surrounding area.
            </p>
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-12 text-center font-[family-name:var(--font-serif)] text-[28px] text-white md:text-[36px]">
              Why Cameron Park Families Choose Us
            </h2>
              ...
              {[
                {
                  ...
                  detail: "Serving Cameron Park since day one.",
                },
                {
                  stat: "5.0",
                  label: "Google Rating",
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-[800px] px-6">
            ...
            <p className="mx-auto mb-12 max-w-[550px] text-center text-[17px] text-dark-gray">
              Common questions from Cameron Park homeowners about our cleaning services.
            </p>
        ...
        <section className="bg-light-bg py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <p className="mx-auto mb-10 max-w-[600px] text-[17px] text-dark-gray">
              In addition to Cameron Park, we provide cleaning services
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[32px] text-white md:text-[48px]">
              Ready for a Cleaner Home in Cameron Park?
            </h2>
            ...
            __html: JSON.stringify([
              {
                ...
                name: "Alexa's Cleaning Services - Cameron Park",
                url: "https://www.alexascleaningplacerville.com/areas/cameron-park",
                telephone: "+15302146361",
                email: "alexascleaningplacerville@gmail.com",
                description:
                  "Professional house cleaning and commercial cleaning services in Cameron Park CA. Licensed, insured, and trusted by local families for over 15 years.",
                areaServed: {
                  "@type": "City",
                  name: "Cameron Park",
                  containedInPlace: {
