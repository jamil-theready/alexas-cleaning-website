...
const services = [
  { name: "House Cleaning", href: "/services/house-cleaning", desc: "Weekly, bi-weekly, or monthly cleaning tailored to your Placerville home." },
  { name: "Deep Cleaning", href: "/services/deep-cleaning", desc: "Top-to-bottom deep clean for seasonal refreshes or move-in prep." },
  { name: "Commercial Cleaning", href: "/services/commercial-cleaning", desc: "Offices, retail, and commercial spaces along Main Street and beyond." },
  { name: "Post-Construction Cleanup", href: "/services/post-construction-cleaning", desc: "Dust, debris, and residue removal after your Placerville renovation." },
  { name: "Airbnb & Vacation Rental", href: "/services/airbnb-cleaning", desc: "Fast turnovers for Gold Country vacation rentals and Airbnbs." },
  { name: "Apartment Cleaning", href: "/services/apartment-cleaning", desc: "Move-in/move-out cleans for Placerville apartments and rentals." },
];

const faqs = [
  {
    q: "How much does house cleaning cost in Placerville?",
    a: "House cleaning in Placerville typically ranges from $120 to $250 depending on the size of your home and the type of clean. We provide free quotes with no obligation so you know exactly what to expect before we start.",
  },
  {
    q: "Do you serve all neighborhoods in Placerville?",
    a: "Yes. We clean homes and businesses throughout Placerville including downtown, Hangtown Creek, Cold Springs Road, Mosquito Road, Smith Flat, and all surrounding neighborhoods. We also serve nearby communities like Cameron Park and Diamond Springs.",
  },
  {
  ...
  },
  {
    ...
    a: "No. We never require contracts. You can schedule weekly, bi-weekly, monthly, or one-time cleans and change or cancel anytime with no fees.",
  },
  {
    q: "How do I book a cleaning in Placerville?",
...
export default function PlacervillePage() {
  return (
    <>
      <Header />
      <main>
        <PageHero
          title="Cleaning Services in Placerville, CA"
          subtitle="Trusted by Placerville families for over 15 years. Licensed, insured, and committed to making your home or business spotless."
        />
          ...
          <div className="mx-auto max-w-[800px] px-6">
            <div className="rounded-2xl border border-yellow/60 bg-white p-6">
              ...
              <p className="text-[16px] leading-relaxed text-dark-gray">
                Alexa&apos;s Cleaning Services is a licensed and insured cleaning
                company based in Placerville, CA with over 15 years of
                experience. We offer house cleaning, deep cleaning, commercial
                cleaning, and specialty services throughout Placerville and El
                Dorado County. No contracts required. Call (530) 214-6361 for a
                free quote.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
                  Placerville&apos;s Most Trusted Cleaning Company
                </h2>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Placerville is where Alexa&apos;s Cleaning Services started
                  over 15 years ago. From historic downtown to the neighborhoods
                  off Highway 49, we know this community because we are part of
                  it. Our founder Alejandra Ortiz built this business one home
                  at a time right here in Placerville, and that local commitment
                  shows in every clean.
                </p>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Whether you live near Hangtown Creek, off Cold Springs Road,
                  or anywhere in between, we provide consistent, reliable
                  cleaning on your schedule. Weekly, bi-weekly, monthly, or
                  one-time deep cleans. No contracts. No rescheduling fees. Just
              ...
              <div className="overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Alexa's Cleaning Services team serving Placerville CA homes"
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-4 text-center font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
              Services Available in Placerville
            </h2>
            <p className="mx-auto mb-12 max-w-[600px] text-center text-[17px] text-dark-gray">
              ...
              services throughout Placerville and the surrounding area.
            </p>
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-12 text-center font-[family-name:var(--font-serif)] text-[28px] text-white md:text-[36px]">
              Why Placerville Families Choose Us
            </h2>
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                {
                  stat: "15+",
                  label: "Years in Placerville",
                  detail: "We started here and we are still here.",
                },
                {
                  stat: "5.0",
                  label: "Google Rating",
                  detail: "Perfect score from real Placerville customers.",
                },
                {
                  stat: "0",
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-[800px] px-6">
            ...
            <p className="mx-auto mb-12 max-w-[550px] text-center text-[17px] text-dark-gray">
              Common questions from Placerville homeowners about our cleaning services.
            </p>
        ...
        <section className="bg-light-bg py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <p className="mx-auto mb-10 max-w-[600px] text-[17px] text-dark-gray">
              In addition to Placerville, we provide cleaning services
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[32px] text-white md:text-[48px]">
              Ready for a Cleaner Home in Placerville?
            </h2>
            ...
            __html: JSON.stringify([
              {
                ...
                name: "Alexa's Cleaning Services - Placerville",
                url: "https://www.alexascleaningplacerville.com/areas/placerville",
                telephone: "+15302146361",
                email: "alexascleaningplacerville@gmail.com",
                description:
                  "Professional house cleaning and commercial cleaning services in Placerville CA. Licensed, insured, and trusted by local families for over 15 years.",
                areaServed: {
                  "@type": "City",
                  name: "Placerville",
                  containedInPlace: {
