...
const services = [
  { name: "House Cleaning", href: "/services/house-cleaning", desc: "Weekly, bi-weekly, or monthly cleaning tailored to your El Dorado Hills home." },
  { name: "Deep Cleaning", href: "/services/deep-cleaning", desc: "Top-to-bottom deep clean for seasonal refreshes or move-in prep in El Dorado Hills." },
  { name: "Commercial Cleaning", href: "/services/commercial-cleaning", desc: "Offices, retail, and commercial spaces near Town Center and the Highway 50 corridor." },
  { name: "Post-Construction Cleanup", href: "/services/post-construction-cleaning", desc: "Dust, debris, and residue removal after your El Dorado Hills renovation or new build." },
  { name: "Airbnb & Vacation Rental", href: "/services/airbnb-cleaning", desc: "Fast turnovers for El Dorado Hills vacation rentals and executive Airbnbs." },
  { name: "Apartment Cleaning", href: "/services/apartment-cleaning", desc: "Move-in/move-out cleans for El Dorado Hills apartments and luxury rentals." },
];

const faqs = [
  {
    q: "How much does house cleaning cost in El Dorado Hills?",
    a: "House cleaning in El Dorado Hills typically ranges from $150 to $300 depending on the size of your home and the type of clean. Many homes in Serrano and the surrounding communities are larger, so we provide free quotes tailored to your specific needs with no obligation.",
  },
  {
    q: "Do you serve Serrano and all El Dorado Hills neighborhoods?",
    a: "Yes. We clean homes and businesses throughout El Dorado Hills including Serrano, the Town Center area, Silva Valley Parkway, Blackstone, Valley View, and all surrounding neighborhoods along the Highway 50 corridor.",
  },
  {
  ...
  {
    q: "Do you clean large homes in El Dorado Hills?",
    a: "Absolutely. We regularly clean homes of all sizes in El Dorado Hills, including larger properties in Serrano and other upscale communities. Our team is equipped and experienced with spacious floor plans, multiple bathrooms, and specialty surfaces.",
  },
  {
    q: "How do I book a cleaning in El Dorado Hills?",
...
export default function ElDoradoHillsPage() {
  return (
    <>
      ...
      <main>
        <PageHero
          title="Cleaning Services in El Dorado Hills, CA"
          subtitle="Trusted by El Dorado Hills families for over 15 years. Licensed, insured, and committed to making your home or business spotless."
        />
          ...
          <div className="mx-auto max-w-[800px] px-6">
            <div className="rounded-2xl border border-yellow/60 bg-white p-6">
              ...
              <p className="text-[16px] leading-relaxed text-dark-gray">
                ...
                cleaning in El Dorado Hills, CA with over 15 years of
                experience. We offer house cleaning, deep cleaning, commercial
                cleaning, and specialty services throughout El Dorado Hills
            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div>
                <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
                  El Dorado Hills&apos; Trusted Cleaning Team
                </h2>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  El Dorado Hills is one of the most desirable communities
                  along the Highway 50 corridor, and we have been cleaning
                  homes here for over 15 years. From the upscale
                  neighborhoods of Serrano to the homes near Town Center and
                  along Silva Valley Parkway, we understand the standards
                  El Dorado Hills homeowners expect. Our founder Alejandra
                  Ortiz built this business one home at a time in El Dorado
                  County, and that dedication shows in every clean.
                </p>
                <p className="mb-6 text-[17px] leading-relaxed text-dark-gray">
                  Whether you live in Serrano, near the Blackstone community,
                  off Silva Valley Parkway, or anywhere in El Dorado Hills,
                  we provide consistent, reliable cleaning on your schedule.
              ...
              <div className="overflow-hidden rounded-2xl">
                <img
                  ...
                  alt="Alexa's Cleaning Services team serving El Dorado Hills CA homes"
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6">
            <h2 className="mb-4 text-center font-[family-name:var(--font-serif)] text-[28px] text-burgundy md:text-[36px]">
              Services Available in El Dorado Hills
            </h2>
            <p className="mx-auto mb-12 max-w-[600px] text-center text-[17px] text-dark-gray">
              ...
              services throughout El Dorado Hills and the surrounding area.
            </p>
        ...
        {/* Why El Dorado Hills Chooses Us */}
              ...
              {[
                {
                  ...
                  detail: "Trusted across El Dorado Hills neighborhoods.",
                },
                {
                  stat: "5.0",
                  label: "Google Rating",
        ...
        <section className="bg-white py-16 md:py-24">
          <div className="mx-auto max-w-[800px] px-6">
            ...
            <p className="mx-auto mb-12 max-w-[550px] text-center text-[17px] text-dark-gray">
              Common questions from El Dorado Hills homeowners about our cleaning services.
            </p>
        ...
        <section className="bg-light-bg py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            ...
            <p className="mx-auto mb-10 max-w-[600px] text-[17px] text-dark-gray">
              In addition to El Dorado Hills, we provide cleaning services
        ...
        <section className="bg-burgundy py-16 md:py-24">
          <div className="mx-auto max-w-7xl px-6 text-center">
            <h2 className="mb-6 font-[family-name:var(--font-serif)] text-[32px] text-white md:text-[48px]">
              Ready for a Cleaner Home in El Dorado Hills?
            </h2>
            ...
            __html: JSON.stringify([
              {
                ...
                name: "Alexa's Cleaning Services - El Dorado Hills",
                url: "https://www.alexascleaningplacerville.com/areas/el-dorado-hills",
                telephone: "+15302146361",
                email: "alexascleaningplacerville@gmail.com",
                description:
                  "Professional house cleaning and commercial cleaning services in El Dorado Hills CA. Licensed, insured, and trusted by local families for over 15 years.",
                areaServed: {
                  "@type": "City",
